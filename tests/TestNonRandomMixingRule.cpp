...
TEST_CASE("Can evaluate the attraction and covolume of a Mixture", "[NonRandomMixingRule]"){
    ...
    CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(A1,5))==0.4401); CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(B1,5))==0.0693);
    CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(A2,5))==0.3521); CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(B2,5))==0.0554);
    CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(A3,5))==0.2641); CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(B3,5))==0.0416);
    CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(A4,5))==0.3437); CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(B4,5))==0.0631);
    CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(A5,5))==0.2778); CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(B5,5))==0.0505);
    CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(A6,5))==0.2084); CHECK(Catch::Approx(PhaseBehavior::Math::roundUp(B6,5))==0.0379);
