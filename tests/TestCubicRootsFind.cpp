...
TEST_CASE("cubic roots find function can solve cubic polynomials", "[cubicRootsFind]"){
    ...
    SECTION("Finds three roots in a polynomial"){
        auto roots = PhaseBehavior::Math::cubicRootsFind<PhaseBehavior::Types::NumericalPrecision>(-6,11,-6);
    ...
    SECTION("Finds only one real root in a polynomial (two imaginary roots)"){
        auto roots = PhaseBehavior::Math::cubicRootsFind<PhaseBehavior::Types::NumericalPrecision>(-7.8693,13.3771,-6.5354);
