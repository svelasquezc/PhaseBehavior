...
TEST_CASE("Can converge to the correct equilibrium coefficients using Newton", "[SussesiveSubstitution]"){
    ...
    SECTION("Using PR for 500 psia and 50 F"){
        ...
        {
            PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::PR::PengRobinson>(mixture, 500 /*psia*/, 50 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using SRK for 500 psia and 50 F"){
        ...
        PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::SRK::SoaveRedlichKwong>(mixture, 500 /*psia*/, 50 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using PR for 400 psia and 50 F"){
        ...
        {
            PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::PR::PengRobinson>(mixture, 400 /*psia*/, 50 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using SRK for 400 psia and 50 F"){
        ...
        PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::SRK::SoaveRedlichKwong>(mixture, 400 /*psia*/, 50 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using PR for 300 psia and 50 F"){
        ...
        {
            PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::PR::PengRobinson>(mixture, 300 /*psia*/, 50 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using SRK for 300 psia and 50 F"){
        ...
        PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::SRK::SoaveRedlichKwong>(mixture, 300 /*psia*/, 50 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using PR for 300 psia and 100 F"){
        ...
        {
            PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::PR::PengRobinson>(mixture, 300 /*psia*/, 100 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using SRK for 300 psia and 100 F"){
        ...
        PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::SRK::SoaveRedlichKwong>(mixture, 300 /*psia*/, 100 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using PR for 400 psia and 100 F"){
        ...
        {
            PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::PR::PengRobinson>(mixture, 400 /*psia*/, 100 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using SRK for 400 psia and 100 F"){
        ...
        PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::SRK::SoaveRedlichKwong>(mixture, 400 /*psia*/, 100 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using PR for 500 psia and 100 F"){
        ...
        {
            PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::PR::PengRobinson>(mixture, 500 /*psia*/, 100 + 460 /*R*/, true, true, 1e-4);
    ...
    SECTION("Using SRK for 500 psia and 100 F"){
        ...
        PhaseBehavior::VaporLiquidEquilibrium::succesiveSubstitution<PhaseBehavior::EoS::SRK::SoaveRedlichKwong>(mixture, 500 /*psia*/, 100 + 460 /*R*/, true, true, 1e-4);
