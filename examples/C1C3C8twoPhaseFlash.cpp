...
int main(){
    ...
    if (result == PhaseBehavior::VaporLiquidEquilibrium::PhaseStabilityResult::Unstable){
        ...
        auto liquidVolumeFraction = 1/(1 + (C1C3C8.molarFraction(PhaseBehavior::PhaseName::vapor)/C1C3C8.molarFraction(PhaseBehavior::PhaseName::liquid))*(liquidMolarDensity/gasMolarDensity));
