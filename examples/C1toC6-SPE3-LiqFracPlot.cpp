...
int main(){
    ...
    PhaseBehavior::Mixture C1toC6{{C1, 0.6223}, {C2, 0.1408}, {C3, 0.0835}, {C4, 0.0438}, {C5, 0.0232}, {C6, 0.0864}};

    auto casePressure = 14e3 /*[kPa]*/;
    auto endPressure = 1e3 /*[kPa]*/;
    int numSteps = 300;
    ...
    outputFile.open("C1toC6-SPE3-liquidFraction.csv");
