...
int main(){
    ...
    PhaseBehavior::Mixture SPE3{{C1, composition[0]}, {C2, composition[1]}, {C3, composition[2]}, {C4, composition[3]}, {C5, composition[4]}, {C6, composition[5]}};


    auto casePressure = 1.6e3 /*[kPa]*/;
    ...
    if (result == PhaseBehavior::VaporLiquidEquilibrium::PhaseStabilityResult::Unstable){
        ...
        double COMSOLInitialDensityL = 14000.0;
